...
namespace AntStrength
{
  ...
  /// </summary>
  public sealed partial class MainPage : AntStrength.Common.LayoutAwarePage
  {
    public MainPage()
    {
    ...
    protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
    {
      ...
      if (null != dataSource)
      { 
        this.DefaultViewModel["WorkoutLog"] = dataSource.WorkoutLog;
        this.DefaultViewModel["WorkingSetLog"] = dataSource.WorkingSetLog;
      }
